        ...
        <div className="flex flex-wrap gap-6 justify-center">
          {courses.map((course) => (
            <div
              ...
              className="flex items-center justify-between bg-gray-50 border border-gray-300 bg-white rounded-2xl shadow-xl hover:shadow-lg transition w-[46%] px-4 py-3 max-md:w-[90%]"
            >
              <img
                src={course.p_link}
              ...
              <Link to={`/course/${course.course_id}`} className="ml-3">
                <button className="bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-indigo-700 transition max-md:px-2 max-md:py-1 max-md:text-[10px]">
                  Start Learning
                </button>
              </Link>
            </div>
